...
<body>
	...
	<table cellspacing="0">
		...
		<tr>
			...
			<?php if (is_dir(VARPATH.'cache') AND is_writable(VARPATH.'cache')): ?>
				<td class="pass"><?php echo VARPATH.'cache/' ?></td>
			<?php else: $failed = TRUE ?>
				<td class="fail">The <code><?php echo VARPATH.'cache/' ?></code> directory is not writable.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>Logs Directory</th>
			<?php if (is_dir(VARPATH) AND is_dir(VARPATH.'log') AND is_writable(VARPATH.'log')): ?>
				<td class="pass"><?php echo VARPATH.'log/' ?></td>
			<?php else: $failed = TRUE ?>
				<td class="fail">The <code><?php echo VARPATH.'log/' ?></code> directory is not writable.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>PCRE UTF-8</th>
